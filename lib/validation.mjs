...
export function validateScore(b, elapsed, mode = "classic") {
  ...
  if (mode === "dash") {
    ...
    if (
      // Endless runs can legitimately last longer than 30 minutes. Allow a
      // signed finished run to retry after an outage, while bounding play time.
      elapsed > 7 * 86400000 ||
      b.durationMs > 6 * 3600000 ||
      b.durationMs < 1000 ||
